...
/// Staff access code — generated by the admin from the admin control panel
/// (PLAN §4.1, §37). A staff member (reception or admin) enters this code at
/// the unified login screen; the system validates it and routes the user to
/// the role-specific dashboard. Codes are revocable and time-limited.
class StaffAccess {
  final String id;
  final String code; // e.g. "ADM-100" or "REC-200"
  final String staffName; // human label shown in admin panel
  final String role; // 'admin' | 'reception'
  final DateTime createdAt;
  DateTime? expiresAt;
  DateTime? lastUsedAt;
